...
export default function Home(){
  ...
  // These view functions close over the page state. Render their JSX directly so
  // React does not treat a newly-created nested function as a new component type
  // on every keystroke and remount the active form.
